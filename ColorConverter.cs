namespace HueAutomation
{
    public class ColorConverter
    {
        ...
        public (double x, double y, double z) TemperatureToXyz(double temp)
        {
            var rgb = TemperatureToRgb(temp);
            return RgbToXyz(rgb);
        }
        public (double x, double y, double z) RgbToXyz((double R, double G, double B) rgb)
        {
        ...
        public (double r, double g, double b) TemperatureToRgb(double value) => TemperatureToRgb_4Seg(value);
        public (double r, double g, double b) TemperatureToRgb_3Seg(double value)
        {
            double segmentSize = (Max - Min) / 3;
        ...
        public (double r, double g, double b) TemperatureToRgb_4Seg(double value)
        {
